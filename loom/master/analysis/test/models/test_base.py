...
class TestBaseModel(TestCase):
    ...
    def test_get_by_abbreviated_id(self):
        wf = Workflow.create(fixtures.workflow_struct)
        id = wf._id
        short_id = id[0:7]
    ...
    def test_get_by_name_or_id_where_both_match(self):
        wf1 = Workflow.create(fixtures.workflow_struct)
        ambiguous_id = wf1._id[0:5]
        wf2_struct = copy.deepcopy(fixtures.workflow_struct)
        wf2_struct['workflow_name'] = ambiguous_id
