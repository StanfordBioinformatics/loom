...
class TestBaseModel(TestCase):
    ...
    def test_get_by_abbreviated_id(self):
        wf = Workflow.create(fixtures.flat_workflow)
        id = wf._id
        short_id = id[0:7]
    ...
    def test_get_by_name_or_id_where_both_match(self):
        wf1 = Workflow.create(fixtures.flat_workflow)
        ambiguous_id = wf1._id[0:5]
        wf2 = deepcopy(fixtures.flat_workflow)
        wf2['name'] = ambiguous_id
        wf2 = Workflow.create(wf2)
