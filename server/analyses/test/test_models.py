...
class TestModels(TestCase):
    ...
    def testDockerImage(self):
        ...
        # Test round trip
        id1 = docker_image._id
        docker_image = DockerImage.create(docker_image.to_json())
        self.assertEqual(docker_image._id, id1)
    ...
    def testEnvironment(self):
        ...
        # Test round trip
        id1 = environment._id
        environment = Environment.create(environment.to_json())
        self.assertEqual(environment._id, id1)
    ...
    def testInputPort(self):
        ...
        # Test round trip
        id1 = input_port._id
        input_port = InputPort.create(input_port.to_json())
        self.assertEqual(input_port._id, id1)
    ...
    def testOutputPort(self):
        ...
        # Test round trip
        id1 = output_port._id
        output_port = OutputPort.create(output_port.to_json())
        self.assertEqual(output_port._id, id1)
    ...
    def testInputBinding(self):
        ...
        # Test round trip
        id1 = input_binding._id
        input_binding = InputBinding.create(input_binding.to_json())
        self.assertEqual(input_binding._id, id1)
    ...
    def testStepTemplate(self):
        ...
        # Test round trip
        id1 = step_template._id
        step_template = StepTemplate.create(step_template.to_obj())
        self.assertEqual(step_template._id, id1)
    ...
    def testStep(self):
        ...
        # Test round trip
        id1 = step._id
        step = Step.create(step.to_json())
        self.assertEqual(step._id, id1)
    ...
    def testFileRecipe(self):
        ...
        # Test round trip
        id1 = file_recipe._id
        file_recipe = FileRecipe.create(file_recipe.to_json())
        self.assertEqual(file_recipe._id, id1)
    ...
    def testResourceSet(self):
        ...
        # Test round trip
        id1 = resource_set._id
        resource_set = ResourceSet.create(resource_set.to_obj())
        self.assertEqual(resource_set._id, id1)
    ...
    def testAnalysisRequest(self):
        ...
        # Test round trip
        id1 = analysis_request._id
        analysis_request = AnalysisRequest.create(analysis_request.to_json())
        self.assertEqual(analysis_request._id, id1)
