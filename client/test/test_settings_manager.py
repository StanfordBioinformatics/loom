...
class TestSettingsManager(unittest.TestCase):
    ...
    # This test no longer applies; SettingsManager can overwrite settings file
    # (for instance, to update current preset)
    ...
    # This test no longer applies; SettingsManager now creates default
    # settings file if no filename provided
