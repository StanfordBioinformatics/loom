...
celery -A loomengine_server.loomengine_server -P eventlet worker --concurrency=${LOOM_WORKER_CELERY_CONCURRENCY} --loglevel=${LOOM_LOG_LEVEL} --workdir=${BIN_PATH}/../server --without-gossip
