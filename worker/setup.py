...
def _get_version():
    versionpath = path.join(here, 'loomengine_worker', 'VERSION')
...
setup(
    ...
    description='loom workflow engine (worker)',
    ...
    # pip to create the appropriate form of executable for the target platform.
     entry_points={
         'console_scripts': [
             'loom-task-monitor=loomengine_worker.task_monitor:main',
         ],
     },
)
