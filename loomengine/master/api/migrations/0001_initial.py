# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-11-11 23:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('output', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='source', to='api.StepOutput')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[(b'docker', b'Docker')], max_length=255)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('taskenvironment_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='api.TaskEnvironment')),
                ('docker_image', models.CharField(max_length=255)),
            ],
            options={
                'abstract': False,
        ...
        migrations.AddField(
            ...
            name='task',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='environment', to='api.Task'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='step_run',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='resources', to='api.StepRun'),
        ),
        migrations.AddField(
            model_name='steprunoutput',
            name='step_run',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outputs', to='api.StepRun'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='step_run',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='environment', to='api.StepRun'),
        ),
        migrations.AddField(
