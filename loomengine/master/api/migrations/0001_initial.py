# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-06-24 16:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children', to='api.DataObject')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_object', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.DataObject')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.CharField(max_length=255)),
                ('type', models.CharField(choices=[(b'boolean', b'Boolean'), (b'file', b'File'), (b'float', b'Float'), (b'integer', b'Integer'), (b'string', b'String')], max_length=255)),
                ('data_object', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.DataObject')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', jsonfield.fields.JSONField(blank=True, null=True)),
                ('parser', jsonfield.fields.JSONField(blank=True, null=True, validators=[api.models.validators.OutputParserValidator.validate_output_parser])),
                ('data_object', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='task_attempt_output', to='api.DataObject')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', jsonfield.fields.JSONField(blank=True, null=True)),
                ('parser', jsonfield.fields.JSONField(blank=True, null=True, validators=[api.models.validators.OutputParserValidator.validate_output_parser])),
                ('data_object', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='api.DataObject')),
        ...
        migrations.AddField(
            model_name='datanode',
            name='data_object',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='data_nodes', to='api.DataObject'),
        ),
        migrations.AddField(
            model_name='datanode',
            name='parent',
