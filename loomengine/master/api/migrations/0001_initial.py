# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2017-04-04 21:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', jsonfield.fields.JSONField(validators=[api.models.tasks.validate_list_of_ints])),
                ('status_is_running', models.BooleanField(default=True)),
                ('status_is_failed', models.BooleanField(default=False)),
                ('status_is_killed', models.BooleanField(default=False)),
                ('status_is_finished', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_import', jsonfield.fields.JSONField(blank=True, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('environment', jsonfield.fields.JSONField(blank=True, null=True)),
                ('outputs', jsonfield.fields.JSONField(blank=True, null=True)),
                ('inputs', jsonfield.fields.JSONField(blank=True, null=True)),
                ('resources', jsonfield.fields.JSONField(blank=True, null=True)),
