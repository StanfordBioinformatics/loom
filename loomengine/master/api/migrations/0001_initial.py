# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-07-28 03:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[(b'file', b'File'), (b'template', b'Template'), (b'run', b'Run')], max_length=16)),
                ('datetime_created', models.DateTimeField(default=django.utils.timezone.now, editable=False)),
                ('file', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tags', to='api.DataObject')),
                ('run', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tags', to='api.Run')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='tag',
            name='template',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tags', to='api.Template'),
        ),
        migrations.AddField(
            model_name='run',
            name='template',
