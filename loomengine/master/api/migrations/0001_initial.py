# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2017-02-14 15:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(b'STARTING', b'Starting'), (b'RUNNING_PROVISIONING_HOST', b'Provisioning host'), (b'RUNNING_LAUNCHING_MONITOR', b'Launching monitor process on worker'), (b'RUNNING_INITIALIZING_MONITOR', b'Initializing monitor process on worker'), (b'RUNNING_COPYING_INPUTS', b'Copying input files to runtime environment'), (b'RUNNING_CREATING_RUN_SCRIPT', b'Creating run script'), (b'RUNNING_FETCHING_IMAGE', b'Fetching runtime environment image'), (b'RUNNING_CREATING_CONTAINER', b'Creating runtime environment container'), (b'RUNNING_STARTING_ANALYSIS', b'Starting analysis'), (b'RUNNING_EXECUTING_ANALYSIS', b'Running analysis'), (b'RUNNING_SAVING_OUTPUTS', b'Saving outputs'), (b'FINISHED', b'Finished'), (b'FAILED', b'Failed')], default=b'STARTING', max_length=255)),
                ('status_detail', models.CharField(choices=[(b'STARTING', b'Starting'), (b'RUNNING_PROVISIONING_HOST', b'Provisioning host'), (b'RUNNING_LAUNCHING_MONITOR', b'Launching monitor process on worker'), (b'RUNNING_INITIALIZING_MONITOR', b'Initializing monitor process on worker'), (b'RUNNING_COPYING_INPUTS', b'Copying input files to runtime environment'), (b'RUNNING_CREATING_RUN_SCRIPT', b'Creating run script'), (b'RUNNING_FETCHING_IMAGE', b'Fetching runtime environment image'), (b'RUNNING_CREATING_CONTAINER', b'Creating runtime environment container'), (b'RUNNING_STARTING_ANALYSIS', b'Starting analysis'), (b'RUNNING_EXECUTING_ANALYSIS', b'Running analysis'), (b'RUNNING_SAVING_OUTPUTS', b'Saving outputs'), (b'FINISHED', b'Finished'), (b'FAILED', b'Failed')], default=b'STARTING', max_length=255)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(b'STARTING', b'Starting'), (b'RUNNING', b'Running'), (b'FINISHED', b'Finished'), (b'FAILED', b'Failed')], default=b'STARTING', max_length=255)),
                ('status_detail', models.CharField(choices=[(b'STARTING', b'Starting'), (b'RUNNING_PROVISIONING_HOST', b'Provisioning host'), (b'RUNNING_LAUNCHING_MONITOR', b'Launching monitor process on worker'), (b'RUNNING_INITIALIZING_MONITOR', b'Initializing monitor process on worker'), (b'RUNNING_COPYING_INPUTS', b'Copying input files to runtime environment'), (b'RUNNING_CREATING_RUN_SCRIPT', b'Creating run script'), (b'RUNNING_FETCHING_IMAGE', b'Fetching runtime environment image'), (b'RUNNING_CREATING_CONTAINER', b'Creating runtime environment container'), (b'RUNNING_STARTING_ANALYSIS', b'Starting analysis'), (b'RUNNING_EXECUTING_ANALYSIS', b'Running analysis'), (b'RUNNING_SAVING_OUTPUTS', b'Saving outputs'), (b'FINISHED', b'Finished'), (b'FAILED', b'Failed')], default=b'STARTING', max_length=255)),
