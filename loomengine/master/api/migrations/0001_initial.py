# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-05-22 20:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Run',
            fields=[
                ('mpttnode_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='api.MPTTNode')),
                ('uuid', models.CharField(default=api.models.uuidstr, editable=False, max_length=255, unique=True)),
                ('name', models.CharField(max_length=255)),
        ...
        migrations.AddField(
            model_name='mpttnode',
            name='mptt_parent',
            field=mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.MPTTNode'),
        ),
        migrations.AddField(
