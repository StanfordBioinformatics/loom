# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-06-12 21:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_root', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.DataTreeNode')),
                ('run', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inputs', to='api.Run')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='task',
            name='run',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='api.Run'),
        ),
        migrations.AddField(
            model_name='task',
