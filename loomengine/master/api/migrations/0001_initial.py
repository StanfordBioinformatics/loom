# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-06-07 00:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('process_subclass', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            name='Run',
            fields=[
                ('process_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='api.Process')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='task_attempts', to='api.Task')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='process',
            name='process_parent',
            field=mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='process_children', to='api.Process'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='tasktimepoint',
            name='task',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='timepoints', to='api.Task'),
        ),
        migrations.AddField(
            model_name='taskoutput',
            name='task',
        ...
        migrations.AddField(
            model_name='taskattempttimepoint',
            name='task_attempt',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='timepoints', to='api.TaskAttempt'),
        ),
        migrations.AddField(
            model_name='taskattemptoutput',
            name='task_attempt',
