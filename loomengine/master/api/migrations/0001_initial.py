# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2017-04-04 16:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_root', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.DataTreeNode')),
            ],
            bases=(models.Model, api.models.base._FilterMixin),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', jsonfield.fields.JSONField()),
                ('status_is_running', models.BooleanField(default=True)),
                ('status_is_failed', models.BooleanField(default=False)),
                ('status_is_killed', models.BooleanField(default=False)),
                ('status_is_finished', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_resource', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='file_data_objects', to='api.FileResource')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='data_object',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='data_tree_nodes', to='api.DataObject'),
        ),
        migrations.AddField(
            model_name='datatreenode',
            name='parent',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='children', to='api.DataTreeNode'),
        ),
        migrations.AddField(
            model_name='datatreenode',
            name='root_node',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='descendants', to='api.DataTreeNode'),
        ),
        migrations.AddField(
