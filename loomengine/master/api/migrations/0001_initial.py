# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-05-26 21:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('mptt_parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.FileResource')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mptt_parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.FixedStepInput')),
            ],
            bases=(models.Model, api.models.base._FilterMixin),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('data_root', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.DataTreeNode')),
                ('mptt_parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.FixedWorkflowInput')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('mptt_parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.RunRequest')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('data_root', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.DataTreeNode')),
                ('mptt_parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.RunRequestInput')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('mptt_parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.RunTimepoint')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('data_root', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.DataTreeNode')),
                ('mptt_parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.StepRunInput')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.CharField(max_length=255)),
                ('type', models.CharField(choices=[(b'boolean', b'Boolean'), (b'file', b'File'), (b'float', b'Float'), (b'integer', b'Integer'), (b'string', b'String')], max_length=255)),
                ('mode', models.CharField(choices=[(b'scatter', b'Scatter'), (b'no_scatter', b'No Scatter')], max_length=255)),
                ...
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('data_root', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.DataTreeNode')),
                ('mptt_parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.StepRunOutput')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('mptt_parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.Task')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('mptt_parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.TaskAttempt')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('mptt_parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.TaskAttemptTimepoint')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('mptt_parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.TaskTimepoint')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_import', jsonfield.fields.JSONField(blank=True, null=True, validators=[api.models.validators.template_import_validator])),
                ('lft', models.PositiveIntegerField(db_index=True, editable=False)),
                ('rght', models.PositiveIntegerField(db_index=True, editable=False)),
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('data_root', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.DataTreeNode')),
                ('mptt_parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.WorkflowRunConnectorNode')),
            ],
            bases=(models.Model, api.models.base._FilterMixin),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('data_root', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.DataTreeNode')),
                ('mptt_parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.WorkflowRunInput')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('data_root', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.DataTreeNode')),
                ('mptt_parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.WorkflowRunOutput')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('environment', jsonfield.fields.JSONField(blank=True, null=True, validators=[api.models.validators.step_environment_validator])),
                ('outputs', jsonfield.fields.JSONField(blank=True, null=True, validators=[api.models.validators.step_outputs_validator])),
                ('inputs', jsonfield.fields.JSONField(blank=True, null=True, validators=[api.models.validators.step_inputs_validator])),
                ('resources', jsonfield.fields.JSONField(blank=True, null=True, validators=[api.models.validators.step_resources_validator])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('template_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='api.Template')),
                ('outputs', jsonfield.fields.JSONField(blank=True, null=True, validators=[api.models.validators.workflow_outputs_validator])),
                ('inputs', jsonfield.fields.JSONField(blank=True, null=True, validators=[api.models.validators.workflow_inputs_validator])),
                ('channel_bindings', jsonfield.fields.JSONField(blank=True, null=True, validators=[api.models.validators.channel_bindings_validator])),
                ('raw_data', jsonfield.fields.JSONField(blank=True, null=True)),
            ],
            options={
                'abstract': False,
        ...
        migrations.AddField(
            model_name='workflowmembership',
            name='mptt_parent',
            field=mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.WorkflowMembership'),
        ),
        migrations.AddField(
            model_name='template',
            name='mptt_parent',
            field=mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.Template'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='taskoutput',
            name='mptt_parent',
            field=mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.TaskOutput'),
        ),
        migrations.AddField(
            model_name='taskoutput',
            name='task',
        ...
        migrations.AddField(
            model_name='taskinput',
            name='mptt_parent',
            field=mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.TaskInput'),
        ),
        migrations.AddField(
            model_name='taskinput',
            name='task',
        ...
        migrations.AddField(
            model_name='taskattemptoutput',
            name='mptt_parent',
            field=mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.TaskAttemptOutput'),
        ),
        migrations.AddField(
            model_name='taskattemptoutput',
            name='task_attempt',
        ...
        migrations.AddField(
            model_name='taskattemptlogfile',
            name='mptt_parent',
            field=mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.TaskAttemptLogFile'),
        ),
        migrations.AddField(
            model_name='taskattemptlogfile',
            name='task_attempt',
        ...
        migrations.AddField(
            model_name='taskattemptinput',
            name='mptt_parent',
            field=mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.TaskAttemptInput'),
        ),
        migrations.AddField(
            model_name='taskattemptinput',
            name='task_attempt',
        ...
        migrations.AddField(
            model_name='run',
            name='mptt_parent',
            field=mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.Run'),
        ),
        migrations.AddField(
            model_name='run',
            name='template',
        ...
        migrations.AddField(
            model_name='datatreenode',
            name='mptt_parent',
            field=mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.DataTreeNode'),
        ),
        migrations.AddField(
            model_name='datatreenode',
            name='parent',
        ...
        migrations.AddField(
            ...
            name='mptt_parent',
            field=mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.DataObject'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='arraymembership',
            name='mptt_parent',
            field=mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mptt_children', to='api.ArrayMembership'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='step_run',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='inputs', to='api.StepRun'),
        ),
        migrations.AddField(
            model_name='run',
            name='parent',
